...
public abstract class UtilsColorBlobDetector {
    ...
    // Cache
    private static Mat mPyrDownMat = new Mat();
    private static Mat mHsvMat = new Mat();
    private static Mat mMask = new Mat();
    private static Mat mDilatedMask = new Mat();
    private static Mat mHierarchy = new Mat();
    ...
    public static Mat getSpectrum() {
        return mSpectrum;
    }

    public static void setMinContourArea(double area) {
